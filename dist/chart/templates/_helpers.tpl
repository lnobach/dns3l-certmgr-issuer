...
*/}}
{{- define "dns3l-certmgr-issuer.name" -}}
...
*/}}
{{- define "dns3l-certmgr-issuer.fullname" -}}
...
*/}}
{{- define "dns3l-certmgr-issuer.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "dns3l-certmgr-issuer.resourceName" -}}
{{- $fullname := include "dns3l-certmgr-issuer.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "dns3l-certmgr-issuer.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "dns3l-certmgr-issuer.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
